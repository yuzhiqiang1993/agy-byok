...
const PROVIDER_PRESETS = {
  ...
  claude: { nameKey: "presets.claude", protocol: "anthropic_messages", baseUrl: "https://api.anthropic.com", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "C", color: "#d97706", bgColor: "rgba(217, 119, 6, 0.12)" },
  openai: { nameKey: "presets.openai", protocol: "openai_chat_completions", baseUrl: "https://api.openai.com/v1", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "O", color: "#059669", bgColor: "rgba(5, 150, 105, 0.12)" },
  gemini: { nameKey: "presets.gemini", protocol: "gemini_generate_content", baseUrl: "https://generativelanguage.googleapis.com", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "G", color: "#2563eb", bgColor: "rgba(37, 99, 235, 0.12)" },
  deepseek: { nameKey: "presets.deepseek", protocol: "openai_chat_completions", baseUrl: "https://api.deepseek.com", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "D", color: "#3b82f6", bgColor: "rgba(59, 130, 246, 0.12)" },
  ...
  siliconflow: { nameKey: "presets.siliconflow", protocol: "openai_chat_completions", baseUrl: "https://api.siliconflow.cn/v1", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "硅", color: "#2563eb", bgColor: "rgba(37, 99, 235, 0.12)" },
  dashscope: { nameKey: "presets.dashscope", protocol: "openai_chat_completions", baseUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "百", color: "#ea580c", bgColor: "rgba(234, 88, 12, 0.12)" },
  moonshot: { nameKey: "presets.moonshot", protocol: "openai_chat_completions", baseUrl: "https://api.moonshot.cn/v1", category: "recommended official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "K", color: "#e11d48", bgColor: "rgba(225, 29, 72, 0.12)" },
  zhipu: { nameKey: "presets.zhipu", protocol: "openai_chat_completions", baseUrl: "https://open.bigmodel.cn/api/paas/v4", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "智", color: "#3b82f6", bgColor: "rgba(59, 130, 246, 0.12)" },
  minimax: { nameKey: "presets.minimax", protocol: "openai_chat_completions", baseUrl: "https://api.minimaxi.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "M", color: "#8b5cf6", bgColor: "rgba(139, 92, 246, 0.12)" },
  hunyuan: { nameKey: "presets.hunyuan", protocol: "openai_chat_completions", baseUrl: "https://api.hunyuan.cloud.tencent.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "混", color: "#0284c7", bgColor: "rgba(2, 132, 199, 0.12)" },
  volcengine: { nameKey: "presets.volcengine", protocol: "openai_chat_completions", baseUrl: "https://ark.cn-beijing.volces.com/api/v3", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "火", color: "#dc2626", bgColor: "rgba(220, 38, 38, 0.12)" },
  qianfan: { nameKey: "presets.qianfan", protocol: "openai_chat_completions", baseUrl: "https://qianfan.baidubce.com/v2", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "千", color: "#2563eb", bgColor: "rgba(37, 99, 235, 0.12)" },
  baichuan: { nameKey: "presets.baichuan", protocol: "openai_chat_completions", baseUrl: "https://api.baichuan-ai.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "百", color: "#f59e0b", bgColor: "rgba(245, 158, 11, 0.12)" },
  yi: { nameKey: "presets.yi", protocol: "openai_chat_completions", baseUrl: "https://api.lingyiwanwu.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "零", color: "#10b981", bgColor: "rgba(16, 185, 129, 0.12)" },
  xunfei: { nameKey: "presets.xunfei", protocol: "openai_chat_completions", baseUrl: "https://spark-api-open.xf-yun.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "星", color: "#0284c7", bgColor: "rgba(2, 132, 199, 0.12)" },
  stepfun: { nameKey: "presets.stepfun", protocol: "openai_chat_completions", baseUrl: "https://api.stepfun.com/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "阶", color: "#7c3aed", bgColor: "rgba(124, 58, 237, 0.12)" },
  ...
  mistral: { nameKey: "presets.mistral", protocol: "openai_chat_completions", baseUrl: "https://api.mistral.ai/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "M", color: "#ea580c", bgColor: "rgba(234, 88, 12, 0.12)" },
  xai: { nameKey: "presets.xai", protocol: "openai_chat_completions", baseUrl: "https://api.x.ai/v1", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "X", color: "#0f172a", bgColor: "rgba(15, 23, 42, 0.12)" },
  perplexity: { nameKey: "presets.perplexity", protocol: "openai_chat_completions", baseUrl: "https://api.perplexity.ai", category: "official", tagKey: "models.tagOfficial", tagClass: "official-tag", icon: "P", color: "#0d9488", bgColor: "rgba(13, 148, 136, 0.12)" },
